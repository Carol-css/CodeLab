...
public class CVideoFragment extends Fragment {
    ...
    public static CVideoFragment newInstance(int videoResId, String theoryText) {
        CVideoFragment fragment = new CVideoFragment();
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_c_video, container, false);
